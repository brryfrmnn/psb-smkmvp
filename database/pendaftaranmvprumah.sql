...
--
-- Host: 127.0.0.1
-- Generation Time: 02 Agu 2015 pada 21.55
-- Versi Server: 5.6.24
-- PHP Version: 5.6.8
...
(19, 2, '4', '4', '1999-11-11', 'l', 'a', '(4__) ___-____', 4, '3', '3', '3', '33', 1, '1999/1999', '2', 3, '15001', 0, '2015-08-02 19:42:21', '2015-08-02 19:42:21');
...
(7, 'beary', '2a370a990ae996c3dfe7c27b621e1c66', 'beruang', 'api', 'beruang@bear.com', '08888888888', 0, 'b7d60ba6e48d4ac36504d0e44d864fd7947335e8', 1, '2015-07-10 17:37:22', '2015-08-02 19:05:20'),
...
ALTER TABLE `mvp_calon_siswa`
  ADD PRIMARY KEY (`calon_siswa_id`), ADD UNIQUE KEY `nisn` (`nisn`), ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `mvp_cara_daftar`
--
ALTER TABLE `mvp_cara_daftar`
  ADD PRIMARY KEY (`cara_daftar_id`), ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `mvp_file_calon_siswa`
--
ALTER TABLE `mvp_file_calon_siswa`
  ADD PRIMARY KEY (`file_calon_siswa_id`), ADD KEY `user_id` (`user_id`);
...
ALTER TABLE `mvp_konfirmasi`
  ADD PRIMARY KEY (`konfirmasi_id`), ADD KEY `user_id` (`user_id`);
...
ALTER TABLE `mvp_orangtua`
  ADD PRIMARY KEY (`orangtua_id`), ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `mvp_provinsi`
--
ALTER TABLE `mvp_provinsi`
  ADD PRIMARY KEY (`provinsi_id`), ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `mvp_siswa`
--
ALTER TABLE `mvp_siswa`
  ADD PRIMARY KEY (`siswa_id`), ADD UNIQUE KEY `nisn` (`nisn`), ADD KEY `user_id` (`user_id`);
...
--
ALTER TABLE `mvp_asal_sekolah`
  MODIFY `asal_sekolah_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `mvp_calon_siswa`
--
ALTER TABLE `mvp_calon_siswa`
  MODIFY `calon_siswa_id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
...
--
ALTER TABLE `mvp_orangtua`
  MODIFY `orangtua_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
