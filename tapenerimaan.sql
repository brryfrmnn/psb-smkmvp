...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 11, 2015 at 02:34 PM
...
--
-- Database: `tapenerimaan`
--

-- --------------------------------------------------------

--
-- Table structure for table `mvp_asal_sekolah`
--
...
--
-- Dumping data for table `mvp_asal_sekolah`
--
...
--
-- Table structure for table `mvp_calon_siswa`
--

CREATE TABLE IF NOT EXISTS `mvp_calon_siswa` (
  `calon_siswa_id` int(20) NOT NULL AUTO_INCREMENT,
  ...
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`calon_siswa_id`),
  UNIQUE KEY `nisn` (`nisn`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=22 ;

--
-- Dumping data for table `mvp_calon_siswa`
--
...
--
-- Table structure for table `mvp_cara_daftar`
--

CREATE TABLE IF NOT EXISTS `mvp_cara_daftar` (
  `cara_daftar_id` tinyint(4) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mvp_file_calon_siswa`
--

CREATE TABLE IF NOT EXISTS `mvp_file_calon_siswa` (
  `file_calon_siswa_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`file_calon_siswa_id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `mvp_file_calon_siswa`
--
...
--
-- Table structure for table `mvp_info`
--
...
--
-- Table structure for table `mvp_info_detail`
--

CREATE TABLE IF NOT EXISTS `mvp_info_detail` (
  `info_detail_id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mvp_jurusan`
--
...
--
-- Table structure for table `mvp_konfirmasi`
--
...
--
-- Dumping data for table `mvp_konfirmasi`
--
...
--
-- Table structure for table `mvp_kontak`
--
...
--
-- Dumping data for table `mvp_kontak`
--
...
--
-- Table structure for table `mvp_kuota`
--
...
--
-- Dumping data for table `mvp_kuota`
--
...
--
-- Table structure for table `mvp_laporan`
--

CREATE TABLE IF NOT EXISTS `mvp_laporan` (
  `laporan_id` int(11) NOT NULL AUTO_INCREMENT,
  `laporan_ket` varchar(20) NOT NULL,
  `laporan_tahun` int(11) NOT NULL,
  `admin_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
-- Table structure for table `mvp_orangtua`
--
...
--
-- Dumping data for table `mvp_orangtua`
--
...
--
-- Table structure for table `mvp_provinsi`
--
...
--
-- Dumping data for table `mvp_provinsi`
--
...
--
-- Table structure for table `mvp_siswa`
--
...
--
-- Dumping data for table `mvp_siswa`
--
...
--
-- Table structure for table `mvp_user`
--
...
--
-- Dumping data for table `mvp_user`
--
...
(17, 'xanyasucla', '', 'gagaga', 'fafafaf', 'fafafa@tata.ta', '', 1, 'ec08732ef9031da32f428d2315b8094f2492233e', 1, '2015-08-10 06:04:30', '2015-08-10 06:38:49');
...
--
-- Constraints for table `mvp_calon_siswa`
--
...
--
-- Constraints for table `mvp_file_calon_siswa`
--
...
--
-- Constraints for table `mvp_konfirmasi`
--
...
--
-- Constraints for table `mvp_orangtua`
--
...
--
-- Constraints for table `mvp_siswa`
--
